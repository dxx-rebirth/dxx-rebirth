...
void bm_write_all(PHYSFS_File *fp)
{
	...
	PHYSFSX_printf(tfile, "NumTextures = %d, Textures array = %d, TmapInfo array = %d\n", NumTextures, static_cast<int>(sizeof(bitmap_index))*NumTextures, static_cast<int>(sizeof(tmap_info))*NumTextures);
	...
	PHYSFSX_printf(tfile, "Num_reactors = %d, Reactors array = %d\n", Num_reactors, static_cast<int>(sizeof(*Reactors))*Num_reactors);
