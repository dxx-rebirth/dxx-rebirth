...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/ksegsize.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:45:49 $
 *
 * Functions for sizing segments
 *
 * $Log: ksegsize.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:49  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: ksegsize.c,v 1.1.1.1 2006/03/17 19:45:49 zicodxx Exp $";
#endif
