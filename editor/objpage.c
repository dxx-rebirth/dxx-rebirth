...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/objpage.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:45:53 $
 * 
 * object selection stuff.
 * 
 * $Log: objpage.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:53  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: objpage.c,v 1.1.1.1 2006/03/17 19:45:53 zicodxx Exp $";
#endif
