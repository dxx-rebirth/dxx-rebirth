...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/kmine.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:45:21 $
 *
 * Functions to change entire mines.
 *
 * $Log: kmine.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:21  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: kmine.c,v 1.1.1.1 2006/03/17 19:45:21 zicodxx Exp $";
#endif
