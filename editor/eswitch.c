...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/eswitch.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:45:22 $
 * 
 * Editor switch functions. 
 * 
 * $Log: eswitch.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:22  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: eswitch.c,v 1.1.1.1 2006/03/17 19:45:22 zicodxx Exp $";
#endif
