...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/centers.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 ...
 * 
 * $Log: centers.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:25  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: centers.c,v 1.1.1.1 2006/03/17 19:45:25 zicodxx Exp $";
#endif
