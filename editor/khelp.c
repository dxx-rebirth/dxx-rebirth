...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/khelp.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:45:17 $
 *
 * Functions for showing help.
 *
 * $Log: khelp.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:17  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: khelp.c,v 1.1.1.1 2006/03/17 19:45:17 zicodxx Exp $";
#endif
