...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/editor/kbuild.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:45:26 $
 *
 * Functions for building parts of mines.
 *
 * $Log: kbuild.c,v $
 * Revision 1.1.1.1  2006/03/17 19:45:26  zicodxx
 * initial import
 *
...
#ifdef RCS
static char rcsid[] = "$Id: kbuild.c,v 1.1.1.1 2006/03/17 19:45:26 zicodxx Exp $";
#endif
