...
#elif DXX_BUILD_DESCENT == 2
	(void)wallupdate;
	if (Viewer == LevelUniqueObjectState.Guided_missile.get_player_active_guided_missile(LevelUniqueObjectState.Objects.vmptr, Player_num))
...
// 				if (Afterburner_charge < 0) Afterburner_charge=f1_0;
		...
		case ND_EVENT_PLAYER_FLAGS: {
			...
			if ((old_player_flags & player_flag::quad_lasers) != (new_player_flags & player_flag::quad_lasers))
