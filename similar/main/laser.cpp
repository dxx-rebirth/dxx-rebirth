...
static imobjptridx_t Laser_player_fire_spread_delay(fvmsegptridx &vmsegptridx, const vmobjptridx_t obj, const weapon_id_type laser_type, const gun_num_t gun_num, const fix spreadr, const fix spreadu, const fix delay_time, const weapon_sound_flag make_sound, const vms_vector &shot_orientation, const icobjidx_t Network_laser_track)
{
	vms_vector	LaserDir;
	fvi_info		hit_data;
	vms_vector	*pnt;
...
//	-----------------------------------------------------------------------------------------------------------
static imobjptridx_t Laser_player_fire_spread(const vmobjptridx_t obj, const weapon_id_type laser_type, const gun_num_t gun_num, const fix spreadr, const fix spreadu, const weapon_sound_flag make_sound, const vms_vector &shot_orientation, const icobjidx_t Network_laser_track)
{
...
//	-----------------------------------------------------------------------------------------------------------
imobjptridx_t Laser_player_fire(const vmobjptridx_t obj, const weapon_id_type laser_type, const gun_num_t gun_num, const weapon_sound_flag make_sound, const vms_vector &shot_orientation, const icobjidx_t Network_laser_track)
{
...
#endif
	{
		const auto &&flare = Laser_player_fire(obj, weapon_id_type::FLARE_ID, gun_num_t::center, weapon_sound_flag::audible, get_local_plrobj().orient.fvec, object_none);
...
int do_laser_firing(vmobjptridx_t objp, int weapon_num, const laser_level level, int flags, vms_vector shot_orientation, const icobjidx_t Network_laser_track)
{
	switch (weapon_num) {
		case primary_weapon_index_t::LASER_INDEX: {
			...
			if (Laser_player_fire(objp, weapon_type, gun_num_t::_0, weapon_sound_flag::audible, shot_orientation, object_none) == object_none)
				 ...
				 */
				return 0;
			Laser_player_fire(objp, weapon_type, gun_num_t::_1, weapon_sound_flag::silent, shot_orientation, object_none);

			if (flags & LASER_QUAD) {
				//	hideous system to make quad laser 1.5x powerful as normal laser, make every other quad laser bolt harmless
				Laser_player_fire(objp, weapon_type, gun_num_t::_2, weapon_sound_flag::silent, shot_orientation, object_none);
				Laser_player_fire(objp, weapon_type, gun_num_t::_3, weapon_sound_flag::silent, shot_orientation, object_none);
			}
			break;
		}
		case primary_weapon_index_t::VULCAN_INDEX: {
			if (Laser_player_fire_spread(objp, weapon_id_type::VULCAN_ID, gun_num_t::center, d_rand()/8 - 32767/16, d_rand()/8 - 32767/16, weapon_sound_flag::audible, shot_orientation, object_none) == object_none)
				return 0;
			break;
		}
		case primary_weapon_index_t::SPREADFIRE_INDEX:
			{
				...
				if (Laser_player_fire_spread(objp, weapon_id_type::SPREADFIRE_ID, gun_num_t::center, spreadr0, spreadu0, weapon_sound_flag::silent, shot_orientation, object_none) == object_none)
					return 0;
				Laser_player_fire_spread(objp, weapon_id_type::SPREADFIRE_ID, gun_num_t::center, spreadr1, spreadu1, weapon_sound_flag::silent, shot_orientation, object_none);
				Laser_player_fire_spread(objp, weapon_id_type::SPREADFIRE_ID, gun_num_t::center, 0, 0, weapon_sound_flag::audible, shot_orientation, object_none);
			}
			break;

		case primary_weapon_index_t::PLASMA_INDEX:
			if (Laser_player_fire(objp, weapon_id_type::PLASMA_ID, gun_num_t::_0, weapon_sound_flag::audible, shot_orientation, object_none) == object_none)
				return 0;
			Laser_player_fire(objp, weapon_id_type::PLASMA_ID, gun_num_t::_1, weapon_sound_flag::silent, shot_orientation, object_none);
			break;

		case primary_weapon_index_t::FUSION_INDEX: {
			vms_vector	force_vec;

			auto &&weapon_obj = Laser_player_fire(objp, weapon_id_type::FUSION_ID, gun_num_t::_0, weapon_sound_flag::audible, shot_orientation, object_none);
			Laser_player_fire(objp, weapon_id_type::FUSION_ID, gun_num_t::_1, weapon_sound_flag::audible, shot_orientation, object_none);
...
#if defined(DXX_BUILD_DESCENT_II)
		case primary_weapon_index_t::GAUSS_INDEX: {
			if (Laser_player_fire_spread(objp, weapon_id_type::GAUSS_ID, gun_num_t::center, (d_rand()/8 - 32767/16)/5, (d_rand()/8 - 32767/16)/5, weapon_sound_flag::audible, shot_orientation, object_none) == object_none)
				return 0;
			break;
		}
		case primary_weapon_index_t::HELIX_INDEX: {
			...
			if (helix_orient < spread.size())
			{
				...
				break;
			if (Laser_player_fire_spread(objp, weapon_id_type::HELIX_ID, gun_num_t::center,  0,  0, weapon_sound_flag::audible, shot_orientation, object_none) == object_none)
				return 0;
			Laser_player_fire_spread(objp, weapon_id_type::HELIX_ID, gun_num_t::center,  spreadr,  spreadu, weapon_sound_flag::silent, shot_orientation, object_none);
			Laser_player_fire_spread(objp, weapon_id_type::HELIX_ID, gun_num_t::center, -spreadr, -spreadu, weapon_sound_flag::silent, shot_orientation, object_none);
			Laser_player_fire_spread(objp, weapon_id_type::HELIX_ID, gun_num_t::center,  spreadr*2,  spreadu*2, weapon_sound_flag::silent, shot_orientation, object_none);
			Laser_player_fire_spread(objp, weapon_id_type::HELIX_ID, gun_num_t::center, -spreadr*2, -spreadu*2, weapon_sound_flag::silent, shot_orientation, object_none);
			break;
		}

		case primary_weapon_index_t::PHOENIX_INDEX:
			if (Laser_player_fire(objp, weapon_id_type::PHOENIX_ID, gun_num_t::_0, weapon_sound_flag::audible, shot_orientation, object_none) == object_none)
				return 0;
			Laser_player_fire(objp, weapon_id_type::PHOENIX_ID, gun_num_t::_1, weapon_sound_flag::silent, shot_orientation, object_none);
			break;

		case primary_weapon_index_t::OMEGA_INDEX:
			if (Laser_player_fire(objp, weapon_id_type::OMEGA_ID, gun_num_t::_1, weapon_sound_flag::audible, shot_orientation, Network_laser_track) == object_none)
				return 0;
			break;
