/*
 * $Source: /cvsroot/dxx-rebirth/d2x-rebirth/arch/dos/digi.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:52:41 $
 *
 * DOS digital audio support
 *
 * $Log: digi.c,v $
 * Revision 1.1.1.1  2006/03/17 19:52:41  zicodxx
 * initial import
 *
 * Revision 1.4  2005/02/25 10:49:48  btb
