/*
 * $Source: /cvsroot/dxx-rebirth/d2x-rebirth/arch/dos/gr.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:52:33 $
 *
 * Graphics functions for DOS.
 *
 * $Log: gr.c,v $
 * Revision 1.1.1.1  2006/03/17 19:52:33  zicodxx
 * initial import
 *
 * Revision 1.1  2001/10/25 08:25:33  bradleyb
