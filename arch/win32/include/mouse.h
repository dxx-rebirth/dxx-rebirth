...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/arch/win32/include/mouse.h,v $
 * $Revision: 1.3 $
 * $Author: michaelstather $
 * $Date: 2006/03/27 18:51:22 $
 *
 * Header for mouse functions
 *
 * $Log: mouse.h,v $
 * Revision 1.3  2006/03/27 18:51:22  michaelstather
 * *** empty log message ***
 *
 * Revision 1.1  2006/03/19 16:04:18  michaelstather
 * *** empty log message ***
 *
 * Revision 1.1.1.1  2006/03/17 19:41:24  zicodxx
 * initial import
 *
