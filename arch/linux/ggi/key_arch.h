...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/arch/linux/ggi/key_arch.h,v $
 * $Revision: 1.1 $
 * $Author: michaelstather $
 * $Date: 2006/03/19 16:02:51 $
 *
 * Header for keyboard functions
 *
 * $Log: key_arch.h,v $
 * Revision 1.1  2006/03/19 16:02:51  michaelstather
 * *** empty log message ***
 *
 * Revision 1.1.1.1  2006/03/17 19:40:53  zicodxx
 * initial import
 *
