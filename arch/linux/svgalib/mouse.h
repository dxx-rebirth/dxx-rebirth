...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/arch/linux/svgalib/mouse.h,v $
 * $Revision: 1.1 $
 * $Author: michaelstather $
 * $Date: 2006/03/19 16:02:52 $
 *
 * Header for mouse functions
 *
 * $Log: mouse.h,v $
 * Revision 1.1  2006/03/19 16:02:52  michaelstather
 * *** empty log message ***
 *
 * Revision 1.1.1.1  2006/03/17 19:40:54  zicodxx
 * initial import
 *
