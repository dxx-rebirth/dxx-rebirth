...
#define SOUND_GOOD_SELECTION_PRIMARY    (PCSharePig ? sound_effect::SOUND_ALREADY_SELECTED : sound_effect::SOUND_GOOD_SELECTION_PRIMARY_FULL_DATA)
#define SOUND_GOOD_SELECTION_SECONDARY  (PCSharePig ? sound_effect::SOUND_ALREADY_SELECTED : sound_effect::SOUND_GOOD_SELECTION_SECONDARY_FULL_DATA)    //      Adam: New sound number here! MK, 01/30/95
#define SOUND_CHEATER                   (PCSharePig ? sound_effect::SOUND_BAD_SELECTION : sound_effect::SOUND_CHEATER_FULL_DATA) // moved by Victor Rachels
#elif DXX_BUILD_DESCENT == 2
#define SOUND_GOOD_SELECTION_PRIMARY	sound_effect::SOUND_GOOD_SELECTION_PRIMARY_FULL_DATA
#define SOUND_GOOD_SELECTION_SECONDARY	sound_effect::SOUND_GOOD_SELECTION_SECONDARY_FULL_DATA
#define SOUND_CHEATER	sound_effect::SOUND_CHEATER_FULL_DATA
#endif
