...
#define MAX_AI_FLAGS    2          // This MUST cause word (4 bytes) alignment in ai_static, allowing for one byte mode
...
{
	ubyte   behavior;               //
	int8_t  flags[MAX_AI_FLAGS + 9];    // various flags, meaning defined by constants
