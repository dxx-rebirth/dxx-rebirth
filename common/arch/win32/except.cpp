...
#define DXX_REPORT_TEXT_FORMAT_UUID	"Format UUID: dfd09b9c-8caa-428c-a294-7d12cbd6cd89"
...
static void *capture_exception_context(dxx_trap_context &dtc)
{
...
"	ud2\n"
		...
		auto p = dtc.ContextRecord.DXX_NT_CONTEXT_REGISTER(sp);
