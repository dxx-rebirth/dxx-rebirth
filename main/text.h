...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/main/text.h,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:43:48 $
 * 
 * Header for text.c, including symbolics for text messages
 * 
 * $Log: text.h,v $
 * Revision 1.1.1.1  2006/03/17 19:43:48  zicodxx
 * initial import
 *
 * Revision 1.1.1.1  1999/06/14 22:13:17  donut
...
#ifndef SHAREWARE
//added/edited on 9/14/98 by Victor Rachels to add more d1x texts
#define TNUM_PRIMARY_CYCLE              621
#define TNUM_SECONDARY_CYCLE            622
#define TNUM_CYCLE_P_TOGGLE             623
#define TNUM_CYCLE_S_TOGGLE             624

//added/edited on 2/4/99 by Victor Rachels for even more d1x texts
#define TNUM_PRIMARY_1                  625
#define TNUM_PRIMARY_2                  626
#define TNUM_PRIMARY_3                  627
#define TNUM_PRIMARY_4                  628
#define TNUM_PRIMARY_5                  629
#define TNUM_SECONDARY_1                630
#define TNUM_SECONDARY_2                631
#define TNUM_SECONDARY_3                632
#define TNUM_SECONDARY_4                633
#define TNUM_SECONDARY_5                634


//added/edited on 2/9/99 by Victor Rachels to add for shareware
#else // shareware
#define TNUM_PRIMARY_CYCLE              514
#define TNUM_SECONDARY_CYCLE            515
#define TNUM_CYCLE_P_TOGGLE             516
#define TNUM_CYCLE_S_TOGGLE             517

#define TNUM_PRIMARY_1                  518
#define TNUM_PRIMARY_2                  519
#define TNUM_PRIMARY_3                  520
#define TNUM_PRIMARY_4                  521
#define TNUM_PRIMARY_5                  522
#define TNUM_SECONDARY_1                523
#define TNUM_SECONDARY_2                524
#define TNUM_SECONDARY_3                525
#define TNUM_SECONDARY_4                526
#define TNUM_SECONDARY_5                527
#endif //notshareware/shareware
//end addition - Victor Rachels

#define N_D1X_TEXT_STRINGS              13
//end addition - Victor Rachels
