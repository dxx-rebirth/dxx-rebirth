...
*/
/*
 * $Source: /cvsroot/dxx-rebirth/d1x-rebirth/main/wall.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: zicodxx $
 * $Date: 2006/03/17 19:44:01 $
 * 
 * Destroyable wall stuff
 * 
 * $Log: wall.c,v $
 * Revision 1.1.1.1  2006/03/17 19:44:01  zicodxx
 * initial import
 *
 * Revision 1.2  2000/06/25 08:34:30  sekmu
 * file-line for segfault info
 *
 * Revision 1.1.1.1  1999/06/14 22:11:59  donut
...
static char rcsid[] = "$Id: wall.c,v 1.1.1.1 2006/03/17 19:44:01 zicodxx Exp $";
