...
extern int ipx_udp_ReceivePacket(ipx_socket_t *unused, char *text, int len, struct ipx_recv_data *rd);
extern int ipx_udp_general_PacketReady(ipx_socket_t *unused);
